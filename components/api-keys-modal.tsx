...
import { getLocalOpenAIApiKey, setOpenAIApiKey, getFinancialDatasetsApiKey, setFinancialDatasetsApiKey } from '@/lib/db/api-keys';
...
export function ApiKeysModal({ 
  ...
  const [openAIKey, setOpenAIKey] = useState(getLocalOpenAIApiKey() || '');
